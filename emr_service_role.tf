...
resource "aws_iam_role" "dataworks_aws_corporate_data_ingestion_emr_service" {
...
resource "aws_iam_role_policy_attachment" "dataworks_aws_corporate_data_ingestion_emr_service_ebs_cmk" {
  role       = aws_iam_role.dataworks_aws_corporate_data_ingestion_emr_service.name
